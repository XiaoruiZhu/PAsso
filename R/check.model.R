#' A set of visualization tools to diagnos the fitted model in the partial association analysis
#'
...
#' surrogate residuals generated from \code{"resids"} function.Graphics are designed
...
#' @param ... This function is based on the \code{"autoplot"} function. Additional optional
#' arguments can be passed onto for drawing various plots.
#'
